...
import com.chaeros.inventory.InventoryTopAppBar
import com.chaeros.inventory.R
import com.chaeros.inventory.data.Item
import com.chaeros.inventory.ui.AppViewModelProvider
import com.chaeros.inventory.ui.item.formatedPrice
...
fun HomeScreen(
    ...
    val homeUiState by viewModel.homeUiState.collectAsState()   // HomeViewModel에서 UI 상태 관찰하며 수집
    ...
    Scaffold(
        ...
        HomeBody(
            itemList = homeUiState.itemList,    // homeUiState 변경 내용을 반영
